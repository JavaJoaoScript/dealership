...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO carros (nome, preco, descricao, descricao_completa, imagem) VALUES ('$nome', '$preco', '$descricao', '$descricao_completa', '$imagem')";
    
    // Executa a query
    if (mysqli_query($conn, $sql)) {
        // Exibe uma mensagem de sucesso
        echo "Carro adicionado com sucesso.";
        header('Location: index.html#carros');
        exit;
    } else {
        // Exibe uma mensagem de erro
        echo "Erro ao adicionar o carro: " . mysqli_error($conn);
    }
